...
a1 = Node('Do you use laptop for > 3 hours per day ?', parent=root, value='null',children=[
    Node('Do you use laptop on sofa / on bed ?',  value='null',label='Have a life'),#5
    Node('Do you use laptop on lap ?',  value='null',label='Have a life'), #6
...
b11 = Node('Do you use iPad/Tablet > 3 hours per day ?', parent=root, value='null',children=[
    Node('Do you use iPad/Tablet on table / on lap (or bed) ?',  value='null',label='')], label='') #16
b2 = Node('Do you use without standing cases ?', parent=root, value='null',label='') #17
